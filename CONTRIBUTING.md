# Contributing to `openssh-operator`

Do you want to contribute to the `openssh-operator` repository? You've come to the right place then!
...
you can use this guide for specific information on contributing to the `openssh-operator` repository.
...
## Hacking on `openssh-operator`

This repository uses [just](https://github.com/casey/just) and [uv](https://github.com/astral-sh/uv) for development
which provide some useful commands that will help you while hacking on `openssh-operator`:
...
### Before opening a pull request on the `openssh-operator` repository
...
By contributing to `openssh-operator`, you agree to license your contribution under
the Apache License 2.0 license.

### Adding a new file to `openssh-operator`
...
### Updating an existing file in `openssh-operator`
